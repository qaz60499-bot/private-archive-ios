...
assert(source.includes('private let photoImportSlots = DispatchSemaphore(value: 3)') && nativePicker.includes('slot.wait()') && nativePicker.includes('slot.signal()'), 'large native photo batches must bound concurrent file-provider materialization')
