...
assert(nativePicker.includes('private func startPhotoImportLane(') && nativePicker.includes('index + stride'), 'native picker must advance each bounded provider lane recursively')
